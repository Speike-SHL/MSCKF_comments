...
\begin{DoxyCompactList}\small\item\em 计算一个路标点的雅可比 \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em 使用不再跟踪上的点来更新 \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em 找出该删的相机状态的id \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classmsckf__vio_1_1_msckf_vio_aa2140c83e2fb3b81ffd5338b0864854d}{prune\+Cam\+State\+Buffer}} ()
\begin{DoxyCompactList}\small\item\em 当cam状态数达到最大值时，挑出若干cam状态待删除 \end{DoxyCompactList}\item 
...
\item 向map\+\_\+server中添加新的特征，和旧特征在新相机帧上的观测
\end{DoxyEnumerate}函数调用图\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
...
\begin{DoxyParams}{参数}
{\em feature\+\_\+id} & 路标点id \\
\hline
{\em cam\+\_\+state\+\_\+ids} & 这个点对应的所有的相机状态id \\
\hline
{\em H\+\_\+x} & 雅可比 \\
\hline
{\em r} & 误差 \\
...
\begin{DoxyParams}{参数}
{\em cam\+\_\+state\+\_\+id} & 有效的相机状态id \\
\hline
{\em feature\+\_\+id} & 路标点id \\
\hline
{\em H\+\_\+x} & 误差相对于位姿的雅可比 \\
\hline
{\em H\+\_\+f} & 误差相对于三维点的雅可比 \\
\hline
{\em r} & 误差 \\
\hline
\end{DoxyParams}
